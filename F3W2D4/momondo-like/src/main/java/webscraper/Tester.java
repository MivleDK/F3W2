...
public class Tester {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Time Parallel: " + ((timeParallel) / 1000000) + " ms.");

        for (TagDTO tg : fd) {
            System.out.println("Url: " + tg.getUrl());
            System.out.println("Div's: " + tg.getDivCount());
            System.out.println("Body's: " + tg.getBodyCount());
            System.out.println("----------------------------------");
        }
        System.out.println("Sequential took: " + timeSequental / 1000000 + " ms");
        System.out.println("Parallel took: " + timeParallel / 1000000 + " ms");
        System.out.println("Difference was " + ((timeSequental - timeParallel) / 1000000 ) + " ms");
